    ...
    <div className="container mx-auto px-4 py-4 font-inter">
            ...
            <div className="mt-8 animate-fadeIn delay-1000">
              <div className="bg-orange-100 border border-orange-200 rounded-lg p-4 max-w-2xl mx-auto">
                <div className="flex items-center justify-center gap-2 text-orange-800">
                  ...
                  <span>
                    Call 999 or contact university security immediately
                  </span>
                  <span className="animate-pulse">🚨</span>
                </div>
              </div>
                ...
                <Link to={feature.link} className="block h-full">
                  ...
                  >
                    ...
                    <div className="card-body relative z-10 p-8">
                      {/* Animated Icon */}
                      <div
                        className="text-5xl mb-6 transform group-hover:scale-125 group-hover:rotate-6 transition-all duration-500 animate-float"
      ...
      <div className="mb-12 relative">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="badge badge-sm bg-red-200 text-red-800 border-none">
                  +15 today
                </div>
              </div>
              ...
              <div className="text-3xl font-bold text-red-600 mb-1 number-pulse">
                245
              </div>
              ...
              <div className="w-full bg-red-200 rounded-full h-3 overflow-hidden">
                <div
                  className="bg-gradient-to-r from-red-500 to-red-600 h-3 rounded-full animate-progressFill shadow-lg"
                  style={{ "--progress-width": "78%", width: "78%" }}
                ></div>
              </div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="badge badge-sm bg-blue-200 text-blue-800 border-none">
                  +8 found
                </div>
              </div>
              ...
              <div className="text-3xl font-bold text-blue-600 mb-1 number-pulse">
                89%
              </div>
              ...
              <div className="w-full bg-blue-200 rounded-full h-3 overflow-hidden">
                <div
                  className="bg-gradient-to-r from-blue-500 to-blue-600 h-3 rounded-full animate-progressFill shadow-lg"
                  style={{ "--progress-width": "89%", width: "89%" }}
                ></div>
              </div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="badge badge-sm bg-green-200 text-green-800 border-none">
                  +50K today
                </div>
              </div>
              ...
              <div className="text-3xl font-bold text-green-600 mb-1 number-pulse">
                ৳4.2L
              </div>
              ...
              <div className="w-full bg-green-200 rounded-full h-3 overflow-hidden">
                <div
                  className="bg-gradient-to-r from-green-500 to-green-600 h-3 rounded-full animate-progressFill shadow-lg"
                  style={{ "--progress-width": "84%", width: "84%" }}
                ></div>
              </div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="badge badge-sm bg-yellow-200 text-yellow-800 border-none">
                  5 upcoming
                </div>
              </div>
              ...
              <div className="text-3xl font-bold text-yellow-600 mb-1 number-pulse">
                32
              </div>
              ...
              <div className="w-full bg-yellow-200 rounded-full h-3 overflow-hidden">
                <div
                  className="bg-gradient-to-r from-yellow-500 to-yellow-600 h-3 rounded-full animate-progressFill shadow-lg"
                  style={{ "--progress-width": "64%", width: "64%" }}
                ></div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <div className="card-body relative z-10 p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="badge badge-sm bg-purple-200 text-purple-800 border-none animate-pulse">
                  Live
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center group">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-purple-700 text-lg number-pulse">
                      156
                    </span>
                    <div className="badge badge-xs bg-green-200 text-green-700 border-none">
                      +12
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center group">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="badge badge-xs bg-blue-200 text-blue-700 border-none">
                      +5
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <div className="w-full bg-purple-200 rounded-full h-3 overflow-hidden">
                    <div
                      className="bg-gradient-to-r from-purple-500 to-pink-500 h-3 rounded-full animate-progressFill shadow-lg relative"
            ...
            {/* Decorative Elements */}
            <div className="absolute top-2 right-2 text-3xl opacity-20 animate-float">
              💼
            </div>
          </div>
          ...
          {/* Medical Aid Stats */}
          <div
            className="stats-card bg-gradient-to-br from-teal-50 via-teal-100 to-teal-200 shadow-xl rounded-xl border border-teal-200 relative overflow-hidden animate-fadeIn"
          ...
          >
            ...
            <div className="card-body relative z-10 p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="badge badge-sm bg-teal-200 text-teal-800 border-none animate-bounce">
                  Active
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center group">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-teal-700 text-lg number-pulse">
                      23
                    </span>
                    <div className="badge badge-xs bg-red-200 text-red-700 border-none">
                      Urgent
                    </div>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center group">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="badge badge-xs bg-yellow-200 text-yellow-700 border-none">
                      +28
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <div className="w-full bg-teal-200 rounded-full h-3 overflow-hidden">
                    <div
                      className="bg-gradient-to-r from-teal-500 to-emerald-500 h-3 rounded-full animate-progressFill shadow-lg relative"
                      style={{ "--progress-width": "91%", width: "91%" }}
                    >
                      <div className="absolute inset-0 bg-white/30 animate-pulse"></div>
                    </div>
                  </div>
            ...
            <div className="absolute top-2 right-2 text-3xl opacity-20 animate-bounce">
              ⚕️
            </div>
          </div>
          ...
          <div
            className="stats-card bg-gradient-to-br from-orange-50 via-orange-100 to-orange-200 shadow-xl rounded-xl border border-orange-200 relative overflow-hidden animate-fadeIn"
          ...
          >
            ...
            <div className="card-body relative z-10 p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="badge badge-sm bg-orange-200 text-orange-800 border-none animate-bounce delay-300">
                  Hot
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center group">
                  <span className="text-sm text-gray-600 group-hover:text-orange-700 transition-colors">
                    Active Notices
                  </span>
                  <div className="flex items-center gap-2">
                    <span className="font-bold text-orange-700 text-lg number-pulse">
                      47
                    </span>
                    <div className="badge badge-xs bg-green-200 text-green-700 border-none">
                      New
                ...
                <div className="flex justify-between items-center group">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="badge badge-xs bg-purple-200 text-purple-700 border-none">
                      +89
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4">
                  ...
                  <div className="w-full bg-orange-200 rounded-full h-3 overflow-hidden">
                    <div
                      className="bg-gradient-to-r from-orange-500 to-yellow-500 h-3 rounded-full animate-progressFill shadow-lg relative"
                      style={{ "--progress-width": "85%", width: "85%" }}
                    >
                      <div className="absolute inset-0 bg-white/30 animate-pulse"></div>
                    </div>
                  </div>
            ...
            <div className="absolute top-2 right-2 text-3xl opacity-20 animate-bounce delay-700">
              📊
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-6 text-center">
              ...
              >
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-500 border border-blue-200 hover:border-blue-300">
                  ...
                  <div className="text-4xl font-bold text-blue-600 mb-2 number-pulse">
                    2,500+
                  </div>
                  <div className="text-sm text-gray-600 font-medium">
                    Active Users
              ...
              >
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-500 border border-yellow-200 hover:border-yellow-300">
                  ...
                  <div className="text-4xl font-bold text-yellow-600 mb-2 number-pulse">
                    850+
                  </div>
                  <div className="text-sm text-gray-600 font-medium">
                    Items Recovered
              ...
              >
                <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-500 border border-purple-200 hover:border-purple-300">
                  ...
                  <div className="text-4xl font-bold text-purple-600 mb-2 number-pulse">
                    95%
                  </div>
                  <div className="text-sm text-gray-600 font-medium">
                    User Satisfaction
            ...
            <div
              className="mt-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-4 text-white animate-fadeIn"
            ...
            >
              <div className="flex items-center justify-center gap-4 text-sm">
                ...
                <span className="animate-fadeIn">
                  🩸 New donor registered 2 min ago
                </span>
                <span className="hidden md:block">|</span>
                <span className="animate-fadeIn delay-300">
                  💰 ৳5,000 donated 5 min ago
                </span>
                <span className="hidden md:block">|</span>
                <span className="animate-fadeIn delay-500">
                  📱 Phone found and returned 8 min ago
                </span>
              </div>
            </div>
          </div>
      ...
      <div className="mb-12 relative">
        ...
        <div className="text-center mb-16 relative z-10">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto animate-fadeIn delay-300">
            Join our community in just three simple steps and start making a
            difference today
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-12 relative">
          ...
          >
            <div className="step-card bg-white rounded-2xl p-8 shadow-xl border-2 border-blue-100 hover:border-blue-300 relative overflow-hidden">
              ...
              {/* Step Number */}
              <div
                className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg animate-numberCount"
                style={{ animationDelay: "0.4s" }}
              >
                1
              </div>
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                  Create your profile and become part of the uniConnect
                  community. It takes just 2 minutes to get started!
                </p>
                ...
                <div className="mt-6 space-y-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  ...
                  <div className="text-xs text-gray-500">
                    Join today and get welcome bonus!
                  </div>
                </div>
              </div>
          ...
          >
            <div className="step-card bg-white rounded-2xl p-8 shadow-xl border-2 border-green-100 hover:border-green-300 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                  Find opportunities to help others or seek assistance when
                  needed. Our smart matching system connects you instantly.
                </p>
                ...
                <div className="mt-6 space-y-2 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                  ...
                  <div className="text-xs text-gray-500">
                    Real-time notifications & matching
                  </div>
                </div>
              </div>
          ...
          >
            <div className="step-card bg-white rounded-2xl p-8 shadow-xl border-2 border-yellow-100 hover:border-yellow-300 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-600 leading-relaxed group-hover:text-gray-700 transition-colors duration-300">
                  Create positive change in your university community. Track
                  your contributions and see the real difference you make.
                </p>
      ...
      <div className="mb-12 relative">
          ...
          >
            ...
            <div className="card-body p-8 relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="activity-time text-sm text-red-600 font-medium">
                  2 hours ago
                </span>
              </div>
              ...
              <div className="mb-6">
                <div className="flex justify-between text-xs mb-2">
                  ...
                  <span className="text-red-700 font-bold">
                    12 volunteers responding
                  </span>
                </div>
                <div className="w-full bg-red-200 rounded-full h-2 overflow-hidden">
                  <div
                    className="bg-gradient-to-r from-red-500 to-red-600 h-2 rounded-full animate-progressFill shadow-sm"
                    style={{ "--progress-width": "60%", width: "60%" }}
                  ></div>
                </div>
              </div>
          ...
          >
            ...
            <div className="card-body p-8 relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="activity-time text-sm text-blue-600 font-medium">
                  4 hours ago
                </span>
              </div>
              ...
              <p className="text-gray-700 text-sm leading-relaxed mb-6">
                <span className="font-semibold text-blue-700">
                  Silver MacBook Pro (2021)
                </span>{" "}
                found near the central library main entrance.
                <span className="block mt-1 text-gray-600">
                  📍 Found by: Sarah Ahmed (CSE Dept)
                </span>
                <span className="block mt-1 text-blue-600 font-medium">
                  🔒 Secure pickup available
                </span>
              </p>
          ...
          >
            ...
            <div className="card-body p-8 relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="activity-time text-sm text-green-600 font-medium">
                  1 day ago
                </span>
              </div>
              ...
              <p className="text-gray-700 text-sm leading-relaxed mb-6">
                Successfully raised{" "}
                <span className="font-bold text-green-700">৳50,000</span> for
                flood victims in Sylhet region.
                <span className="block mt-1 text-gray-600">
                  🎯 Goal: ৳45,000 (111% achieved)
                </span>
                <span className="block mt-1 text-green-600 font-medium">
                  ✅ Funds transferred to relief organizations
                </span>
              </p>
              ...
              <div className="mb-6">
                <div className="grid grid-cols-3 gap-3 text-xs">
                  <div className="bg-green-100 rounded-lg p-3 text-center">
                    <div className="font-bold text-green-700 text-lg number-pulse">
                      127
                    </div>
                    <div className="text-gray-600">Contributors</div>
                  </div>
                  <div className="bg-blue-100 rounded-lg p-3 text-center">
                    <div className="font-bold text-blue-700 text-lg number-pulse">
                      ৳394
                    </div>
                    <div className="text-gray-600">Avg. Donation</div>
                  </div>
                  <div className="bg-yellow-100 rounded-lg p-3 text-center">
                    <div className="font-bold text-yellow-700 text-lg number-pulse">
                      111%
                    </div>
          ...
          >
            ...
            <div className="card-body p-8 relative z-10">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="activity-time text-sm text-yellow-600 font-medium">
                  2 days ago
                </span>
              </div>
              ...
              <p className="text-gray-700 text-sm leading-relaxed mb-6">
                Join us for an exciting workshop on{" "}
                <span className="font-semibold text-yellow-700">
                  AI fundamentals
                </span>{" "}
                this Saturday!
                <span className="block mt-1 text-gray-600">
                  🗓️ Date: Saturday, 2:00 PM - 5:00 PM
                </span>
                <span className="block mt-1 text-orange-600 font-medium">
                  👨‍🏫 Expert: Dr. Rahman (Google AI)
                </span>
              </p>
              ...
              <div className="mb-6">
                ...
                <div className="w-full bg-yellow-200 rounded-full h-3 overflow-hidden">
                  <div
                    className="bg-gradient-to-r from-yellow-500 to-orange-500 h-3 rounded-full animate-progressFill shadow-sm relative"
                    style={{ "--progress-width": "75%", width: "75%" }}
                  >
                    <div className="absolute inset-0 bg-white/30 animate-pulse"></div>
                  </div>
                </div>
        ...
        <div
          className="mt-12 bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-8 shadow-xl animate-fadeIn"
          style={{ animationDelay: "0.5s" }}
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl font-bold text-gray-800 mb-4 flex items-center justify-center gap-2">
              <span className="animate-pulse">📡</span>
              Live Activity Feed
              <span className="badge badge-sm bg-green-500 text-white border-none animate-bounce">
                LIVE
              </span>
            </h3>
            <p className="text-gray-600">
              Real-time updates from your university community
            </p>
          </div>
          ...
          <div className="space-y-4 max-h-64 overflow-y-auto">
            <div className="flex items-center gap-4 bg-white rounded-lg p-4 shadow-sm animate-slideUp">
              ...
              <div className="badge badge-xs bg-red-100 text-red-600">
                Emergency
              </div>
            </div>

            <div
              className="flex items-center gap-4 bg-white rounded-lg p-4 shadow-sm animate-slideUp"
              style={{ animationDelay: "0.1s" }}
            >
              ...
              <div className="flex-1">
                <span className="text-sm text-gray-600">
                  ...
                  iPhone 13 near cafeteria
                </span>
                <div className="text-xs text-gray-400">2 minutes ago</div>
              </div>
              <div className="badge badge-xs bg-blue-100 text-blue-600">
                New
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-1">
                <span className="text-sm text-gray-600">
                  ...
                  ৳1,000 contributed to flood relief
                </span>
                <div className="text-xs text-gray-400">5 minutes ago</div>
              </div>
              <div className="badge badge-xs bg-green-100 text-green-600">
                Thanks
              </div>
            </div>
            ...
            >
              ...
              <div className="flex-1">
                <span className="text-sm text-gray-600">
                  <span className="font-semibold text-yellow-600">Event:</span>{" "}
                  5 new registrations for AI workshop
                </span>
                <div className="text-xs text-gray-400">8 minutes ago</div>
              </div>
              <div className="badge badge-xs bg-yellow-100 text-yellow-600">
                Popular
              </div>
            </div>
          </div>
